...
class Collection(models.Model):
    ...
    floor_price = models.DecimalField('floor price', max_digits=20, decimal_places=4, blank=False, null=False)
    daily_volume = models.DecimalField('daily volume', max_digits=20, decimal_places=4, blank=False, null=False)
    weekly_volume = models.DecimalField('weekly volume', max_digits=20, decimal_places=4, blank=False, null=False)
    monthly_volume = models.DecimalField('monthly volume', max_digits=20, decimal_places=4, blank=False, null=False)
    total_volume = models.DecimalField('total volume', max_digits=20, decimal_places=4, blank=False, null=False)
